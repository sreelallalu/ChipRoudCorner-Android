...
import com.chipsetround.lalism.data.ChipSelectionObserver;
import com.chipsetround.lalism.data.ListChipDataSource;
...
public class ChipsInputLayout extends MaxHeightScrollView
    ...
    public boolean getIsEdittextView()
    {

        return this.chipOptions.edittextvisible;
    }
    ...
    ChipView getThemedChipView() {
        ...
        ChipView chipView = new ChipView.Builder(getContext())
                ...
                .edittextVisible(chipOptions.edittextvisible)
