 ...
 * @version 1.0
 */
public class ChipsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        listchip=chipDataSource.getSelectedChips();



    }
   public static void allList(SelectedListItems selectedlist)
